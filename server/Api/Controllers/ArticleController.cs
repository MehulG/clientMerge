...
namespace Api.Controllers
{
    ...
    public class ArticleController : ControllerBase
    {
        ...
        {
            defaultArticle def = new defaultArticle{};
            if (def.Content != entities.Content || def.Title != entities.Title)
            {
    ...
    public class defaultArticle{
        public string Title = "DefaultTitle";
        public string Content = "{\"ops\":[{\"insert\":\"I am Example content\"},{\"attributes\":{\"header\":3},\"insert\":\"\\n\"}]}";
